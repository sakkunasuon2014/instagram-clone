ALTER TABLE "likes" RENAME TO "like";--> statement-breakpoint
ALTER TABLE "like" DROP CONSTRAINT "likes_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "like" DROP CONSTRAINT "likes_post_id_post_id_fk";
--> statement-breakpoint
